...
export default function NewsPopup({ news, open, setOpen }) {
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-[90vw] min-w-[70vw] sm:max-w-[600px]  overflow-y-auto">
        <DialogHeader>
        ...
        <div className="flex sm:flex-row sm:items-center sm:justify-center flex-col gap-2">
          ...
          <div className="flex flex-col gap-1 px-3 pt-2 min-w-0 flex-1 overflow-hidden">
            <span className="text-md font-thin text-justify tracking-tight text-muted-foreground">{news?.summary}</span>
